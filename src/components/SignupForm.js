        ...
        return (
            <Fragment>
                ...
                <form className={styles.inputForm} onSubmit={this.loginClick}>
                    { this.state.valid ? <input className={cx(styles.Input, styles.gray)} type='text' name='username' 
                    placeholder='Username' onChange={this.handleOnChange}></input> :
                    <input className={cx(styles.Input, styles.red)} type='text' name='username' 
                    placeholder='Username' onChange={this.handleOnChange}></input> }
                    ...
                    <i className="fas fa-lock" style={{marginLeft: '-30px', color: '#a9a9a9'}}></i>
                    <br/>
                    { this.state.valid ? <input className={cx(styles.Input, styles.gray)} type='password' name='password' 
                    placeholder='comfirm password' onSubmit={this.comfirmHandleOnChange}></input> : 
                    <input className={cx(styles.Input, styles.red)} type='password' name='password' 
                    placeholder='comfirm password' onSubmit={this.comfirmHandleOnChange}></input> }

                    <i className="fas fa-lock" style={{marginLeft: '-30px', color: '#a9a9a9'}}></i><br></br>
                    <Button type='submit' className={styles.signup} variant="primary">Sign Up</Button> 
                </form>
            </Fragment>
        )
    }
